...
import { LogOut, User, PlusCircle, Landmark } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 bg-museum-paper/80 backdrop-blur-md border-b border-museum-dark/10 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)]">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-3 group">
            <Landmark className="w-8 h-8 text-museum-dark group-hover:text-museum-accent transition-colors duration-300" />
            <span className="font-serif text-2xl font-semibold tracking-wide text-museum-dark">Exhibits</span>
          </Link>
